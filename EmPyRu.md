...
Перед началом работы с Python в InterSystems IRIS настоятельно рекомендуем установить системный Python версии 3.9.5 для Windows и версии 3.8.10 для Linux.
...
Важно! Обязательно использовать `irispip` от InterSystems. Использовать системный `pip` или `<iris>\bin\pip3` можно только если у вас установлен Python 3.9.5 на Windows или 3.8.10 на Linux (на момент выхода статьи с InterSystems IRIS 2021.2 поставляются именно эти версии Python).

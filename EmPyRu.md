...
```
pip3 install --target /usr/irissys/mgr/python numpy
```

Важно! Использовать системный `pip` можно только если у вас установлен Python 3.9.5 на Windows или 3.8.10 на Linux (на момент выхода статьи с InterSystems IRIS 2021.2 поставляются именно эти версии Python).

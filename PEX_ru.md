...
Наше решение работает в докере и выглядит следующим образом:
...
И, наконец, jar файлы копируются в базовый образ Java Gateway (базовое изображение также обеспечивает запуск Java Gateway шлюза).

...
- План: как только обсуждение задачи завершено, пришло время писать код. Но сначала нам необходимо расставить приоритеты и организовать наш рабочий процесс. Для этого есть этапы, канбан доска, дата исполнения и ответственный.
...
3. Доставка в промышленное окружение
   ...
   - Владелец нажимает кнопку «Развернуть»

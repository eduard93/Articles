...
IAM можно загрузить с сайта [WRC Software Distribution](https://wrc.intersystems.com/wrc/) и запустить как Docker контейнер. Минимальные системные требования:
